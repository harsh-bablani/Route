...
const Footer = () => {
  return (
    <footer className="bg-white text-gray-800 pt-16 pb-8 border-t border-gray-200 shadow-sm">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="mb-8">
            ...
            <ul className="space-y-2">
              <li><Link to="/" className="text-gray-600 hover:text-amber-500 transition-colors">Home</Link></li>
              <li><a href="#about" className="text-gray-600 hover:text-amber-500 transition-colors">About Us</a></li>
              <li><a href="#services" className="text-gray-600 hover:text-amber-500 transition-colors">Our Services</a></li>
              <li><a href="#destinations" className="text-gray-600 hover:text-amber-500 transition-colors">Destinations</a></li>
              <li><a href="#contact" className="text-gray-600 hover:text-amber-500 transition-colors">Contact Us</a></li>
            </ul>
          </div>
          ...
          <div className="mb-8">
            ...
            <ul className="space-y-2">
              <li><Link to="/terms" className="text-gray-600 hover:text-amber-500 transition-colors">Terms & Conditions</Link></li>
              <li><Link to="/refund" className="text-gray-600 hover:text-amber-500 transition-colors">Refund & Cancellation Policy</Link></li>
              <li><Link to="/contact-now" className="text-gray-600 hover:text-amber-500 transition-colors">Contact Now</Link></li>
              <li><Link to="/about-company" className="text-gray-600 hover:text-amber-500 transition-colors">About Company</Link></li>
            </ul>
          </div>
