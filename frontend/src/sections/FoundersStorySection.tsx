...
const FoundersStorySection = () => (
  <section id="founder-story" className="py-20 bg-white">
    <div className="container mx-auto px-4 flex flex-col md:flex-row items-center md:items-stretch gap-10">
      <div className="flex-shrink-0 mb-8 md:mb-0 md:mr-10 flex flex-col items-center w-full md:w-80 bg-white md:bg-amber-50 rounded-2xl md:shadow-lg md:p-8 border-4 border-amber-500/40">
        <img
          src={founderImage}
          alt="Sanjay Bablani"
          className="rounded-xl shadow-lg w-64 h-64 object-cover border-4 border-amber-500 mb-4"
        />
        <h3 className="text-2xl font-bold text-gray-800 mb-2 text-center">Sanjay Bablani</h3>
